...
export default function MovieDetail({obj}:{obj:MovieInfo|undefined}){
    return (
      <>
      {obj &&<div onClick={(e)=>e.stopPropagation()} className='absolute z-[11] h-[100%] modalcontainer'>
        <h1 className='text-[2rem] md:text-[2rem]'>{obj.title}</h1>
        ...
        <p style={{color: "rgb(122, 122, 122)"}}  className='  pt-[2rem] text-[1rem] sm:text-[1rem]  hyphens-auto'>{obj.tagline}</p>
